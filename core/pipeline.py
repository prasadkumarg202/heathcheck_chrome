    ...
    def compute_vitals(
        ...
        return HealthMeasurementResult(
            ...
            heart_rate={
                "value": hr_res.hr_bpm,
                "unit": "BPM",
                "maxHrBpm": hr_res.max_hr_bpm,
                "hrZone": hr_res.hr_zone,
                "hrZonePct": hr_res.hr_zone_pct,
                "hrReservePct": hr_res.hr_reserve_pct,
            ...
            respiration_rate={
                "value": synced_rr_val,
                "unit": "breaths/min",
                "pattern": rr_res.pattern if is_rr_synced_valid else "Indeterminate",
                "ieRatio": rr_res.ie_ratio if is_rr_synced_valid else None,
                "respirationWaveform": rr_res.respiration_waveform if is_rr_synced_valid else None,
            ...
            pulse_rate_variability={
                ...
                "triangularIndex": prv_res.triangular_index if prv_res.is_valid else None,
                "tinnMs": prv_res.tinn_ms if prv_res.is_valid else None,
                "stressResistanceScore": prv_res.stress_resistance_score if prv_res.is_valid else None,
                "cardiacVagalIndex": prv_res.cardiac_vagal_index if prv_res.is_valid else None,
                "cardiacSympatheticIndex": prv_res.cardiac_sympathetic_index if prv_res.is_valid else None,
                "unit": "ms",
            ...
            arrhythmia_screening={
                ...
                "pvcPacBurdenPct": arrhythmia_res.pvc_pac_burden_pct if arrhythmia_res.is_valid else 0.0,
                "poincarePoints": arrhythmia_res.poincare_points if arrhythmia_res.is_valid else [],
            ...
            fitness_vo2max={
                ...
                "fitnessAge": vo2_res.fitness_age if vo2_res.is_valid else None,
                "readinessScore": vo2_res.training_readiness_score if vo2_res.is_valid else None,
                "allostaticLoad": vo2_res.allostatic_load_index if vo2_res.is_valid else None,
                "unit": "mL/kg/min",
            ...
            blood_pressure={
                ...
                "baRatio": bp_res.b_a_ratio if bp_res.is_valid else None,
                "caRatio": bp_res.c_a_ratio if bp_res.is_valid else None,
                "daRatio": bp_res.d_a_ratio if bp_res.is_valid else None,
                "eaRatio": bp_res.e_a_ratio if bp_res.is_valid else None,
                "cardiacOutput": bp_res.cardiac_output_l_min if bp_res.is_valid else None,
                "svr": bp_res.systemic_vascular_resistance if bp_res.is_valid else None,
                "sdppgWaveform": bp_res.sdppg_waveform if bp_res.is_valid else None,
            ...
            metabolic_risks={
                ...
                "tygIndex": metabolic_res.tyg_index if metabolic_res.is_valid else None,
                "tgHdlRatio": metabolic_res.tg_hdl_ratio if metabolic_res.is_valid else None,
                "vai": metabolic_res.visceral_adiposity_index if metabolic_res.is_valid else None,
                "metsScore": metabolic_res.mets_score if metabolic_res.is_valid else None,
            ...
            cvd_risk={
                ...
                "score2RiskPct": cvd_risk_res.score2_risk_pct,
                "lifetimeRiskPct": cvd_risk_res.lifetime_cvd_risk_pct,
                "plaqueRiskCategory": cvd_risk_res.plaque_risk_category,

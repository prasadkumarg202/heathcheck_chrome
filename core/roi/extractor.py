...
class ROIExtractor:
    ...
    def extract_rois(
        ...
        left_cheek_poly = np.array([
            ...
            [int(eye_left_x - eye_dist * 0.04 + cheek_w * 0.5), int(cheek_y - cheek_h * 0.5)],
            [int(eye_left_x - eye_dist * 0.04 + cheek_w * 0.45), int(cheek_y + cheek_h * 0.5)],
            [int(eye_left_x - eye_dist * 0.04 - cheek_w * 0.45), int(cheek_y + cheek_h * 0.5)],
        ], dtype=np.int32)

        right_cheek_poly = np.array([
            [int(eye_right_x + eye_dist * 0.04 - cheek_w * 0.5), int(cheek_y - cheek_h * 0.5)],
            [int(eye_right_x + eye_dist * 0.04 + cheek_w * 0.5), int(cheek_y - cheek_h * 0.5)],
            [int(eye_right_x + eye_dist * 0.04 + cheek_w * 0.45), int(cheek_y + cheek_h * 0.5)],
            [int(eye_right_x + eye_dist * 0.04 - cheek_w * 0.45), int(cheek_y + cheek_h * 0.5)],
        ], dtype=np.int32)
